<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Mensaje2.aspx.cs" Inherits="ConsursoWeb.Mensaje2" %>
            ...
            <div class="row quiPadd" >
                <div class="col-xs-10 col-md-6 col-md-offset-1 quiPadd">
                    ...
                    <div class="col-xs-10 col-xs-offset-1 quiPadd" >
                       <asp:ImageButton CssClass="img-responsive" ID="Image3" ImageUrl="~/Image/login_No_facturacion_Campana_base.png" OnClick="Button1_Click" runat="server"></asp:ImageButton>
                    </div>
                    </center>
