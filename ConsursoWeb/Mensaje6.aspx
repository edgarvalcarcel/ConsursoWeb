<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Mensaje6.aspx.cs" Inherits="ConsursoWeb.Mensaje6" %>
            ...
            <div class="row quiPadd" >
                <div class="col-xs-10 col-md-6 col-md-offset-1 quiPadd">
                    ...
                    <div class="col-xs-10 col-xs-offset-1 quiPadd" >
                       <asp:ImageButton CssClass="img-responsive" ID="Image3" ImageUrl="~/Image/PopUp_Aceptar_TyC.png" OnClick="Button1_Click" runat="server"></asp:ImageButton>
                    </div>
                    </center>
                    </div>
            </div>
