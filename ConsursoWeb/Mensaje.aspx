<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Mensaje.aspx.cs" Inherits="ConsursoWeb.Mensaje" %>
        ...
        <div class="row" >
            ...
            <div class="row quiPadd" >
                <div class="col-xs-10 col-md-6 col-md-offset-1 quiPadd">
                    ...
                    <center>
                    <div class="col-xs-10 col-xs-offset-1 quiPadd" >
                       <asp:ImageButton CssClass="img-responsive" ID="Image3" ImageUrl="~/Image/PopUps_Datos_Erroneos_mas_3_intentos.png" OnClick="Button1_Click" runat="server"></asp:ImageButton>
                    </div>
                    </center>
                        <div class="col-xs-7">

                        </div>
                        <div class="col-xs-4 quiPadd">
                            <asp:ImageButton ID="ImageButton2" runat="server" CssClass="img-responsive imgCont" ImageUrl="~/Image/cont.png" OnClick="Button1_Click" />
                        </div>
                    </div>
                    </center>
            ...
            <div class="col-xs-12 quiPadd footer" style="background-color:black; height:100px;position: fixed;bottom: 0;">
                ...
                <footer class="footer">
                    <div class="col-xs-6 col-md-6" style="padding:4px 90px">
                        <asp:ImageButton ID="ImageButton1" ImageUrl="~/Image/icono_TCDL.png" CssClass="img-responsive" PostBackUrl="~/Paginas/Informacion.aspx" runat="server" />
                    </div>

                    <div class="col-xs-6 col-md-6" style="padding:19px 90px">
                        <asp:ImageButton ID="ImageButton3" ImageUrl="~/Image/icono_MP.png" CssClass="img-responsive Image10"  PostBackUrl="http://www.marketingpersonal.com/" runat="server" />
                    </div>
